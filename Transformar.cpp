...
Transformador::Transformador(string*arr,int NotaInicial,int transformador){
    this->arr=arr;
...
void Transformador::Transformar(){
    ...
    int izquierda_;
    int h;
    int l=0;  //contador hacia la derecha
    int o=0;  // contador hacia la izquierda
    ...
    cout<<"derecha:"<<derecha_<<endl;
                                            // se verifica y se imprime cual es mas rapido
    if(izquierda_<0){
